...
5. **Pulsa "Registrar salida"** en la tabla del carrier que llegó (dentro de su corral). Se abre el escáner: **escanea la etiqueta interna de Torre de CADA caja que sube al camión** (el QR o el código de barras de nuestra etiqueta, no la del carrier). Torre la agrega a la lista y te dice cuántas llevas de las listas. Si una etiqueta no se lee, teclea el folio del pedido o el número de guía. Torre rechaza lo que no es de esta salida: caja de otro carrier, caja sin foto de cierre, caja que ya salió, o repetida. La lista se guarda aunque cierres el teléfono. La lista pendiente va **del pedido más antiguo al más reciente** y arriba te dice cuál sigue: lo viejo sale primero. Si una caja de la lista **no está físicamente en el corral**, pulsa **"No está en salida"** en su renglón (se resuelve al cerrar). Si el chofer se lleva todo, **"Salen todos"** en la tabla del carrier te ahorra el escaneo caja por caja, pero igual confirmas en el resumen. Un pedido con cajas de dos carriers aparece en las dos tablas, cada una con sus cajas: sale por partes, con cada chofer.
...
6. **"Cerrar salida"**: Torre te muestra el resumen — lo escaneado con su palomita, y lo que **se queda** en el corral (lo que no escaneaste no se puede palomear: se escanea o se teclea su folio). Desmarca lo que al final no subió. Las que marcaste "No está en salida" aparecen en su propio bloque con la palomita **"ya salió"** apagada: márcala SOLO si sabes que esa caja se fue antes sin registro (Torre la registra como salida, pero en la hoja va aparte, fuera de lo que firma el chofer hoy); sin palomita, no se toca. Escribe el nombre del chofer y pulsa **"Confirmar salida · N cajas"**. Ahí Torre marca RECOLECTADO lo confirmado y avisa al comprador ("va en camino"); lo demás se queda para la siguiente recolección.
